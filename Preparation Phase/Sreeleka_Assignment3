...
Original file is located at
    https://colab.research.google.com/github/IBM-EPBL/IBM-Project-2770-1658482555/blob/main/Assignment3.ipynb
"""
...
for i in range (4):
    for j in range (2):
        ...
        ax[i,j].set_title("Predicted Flower : "+str(le.inverse_transform([np.argmax(y_test[prop_class[count]])])))
        plt.tight_layout()
        count+=1
